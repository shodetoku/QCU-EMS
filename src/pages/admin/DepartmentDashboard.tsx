...
const DepartmentDashboard: React.FC = () => {
  ...
  const [sectioningStudents, setSectioningStudents] = useState<EnhancedSectioningStudent[]>(mockEnhancedSectioningStudents);
      ...
      <div className="grid md:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">COE Requests</p>
              <p className="text-3xl font-bold text-gray-800">{stats.totalCOE}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Pending COE</p>
              <p className="text-3xl font-bold text-yellow-600">{stats.pendingCOE}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{stats.utilizationRate}%</p>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="font-semibold text-gray-800">Review COE</p>
          ...
          >
            ...
            <p className="font-semibold text-gray-800">Room Scheduling</p>
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-gray-800">COE Verification</h3>
  ...
  const renderSectionListTab = () => {
    ...
    return (
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold text-gray-800">Section Schedule Status</h3>
            <div className="flex items-center space-x-2">
              ...
              return (
                <div
                  ...
                  className={`border rounded-lg p-4 cursor-pointer hover:shadow-md transition-shadow ${
                    status.isComplete ? 'border-green-200 bg-green-50' : 'border-yellow-200 bg-yellow-50'
                  }`}
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h3 className="text-xl font-semibold text-gray-800">Room & Section Scheduling</h3>
            <p className="text-gray-600">Manage room assignments and schedules</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`px-3 py-2 rounded-lg ${scheduleView === 'week' ? 'bg-purple-100 text-purple-700' : 'text-gray-600'}`}
              >
                Week View
              </button>
              <button
                onClick={() => setScheduleView('room')}
                className={`px-3 py-2 rounded-lg ${scheduleView === 'room' ? 'bg-purple-100 text-purple-700' : 'text-gray-600'}`}
              >
                Room View
              </button>
            </div>
  ...
  const renderReportsTab = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-xl font-semibold text-gray-800 mb-4">Room Utilization Report</h3>
          ...
          {rooms.map(room => {
            ...
            return (
              <div key={room.id} className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-gray-800">{room.roomCode}</h4>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-xl font-semibold text-gray-800 mb-4">Section Schedule Report</h3>
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-qcu-deep mb-4">Department Dashboard</h1>
          <p className="text-qcu-gray-600 text-lg">COE Verification, Room Scheduling & Reports Management</p>
        </div>
