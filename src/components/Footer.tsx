  ...
  return (
    <footer className="bg-gradient-to-br from-qcu-dark via-qcu-secondary to-qcu-deep text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="border-t border-white/20 bg-gradient-to-r from-black/20 to-transparent backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h4 className="font-bold text-white text-lg mb-2" style={{ fontFamily: 'Cinzel, serif' }}>
                  Staff Portals
                </h4>
                <p className="text-gray-400 text-sm">For authorized personnel only</p>
              </div>
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <Link
                    key={portal.name}
                    to={portal.path}
                    className={`bg-gradient-to-r ${portal.color} hover:shadow-lg text-white px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 hover:scale-105 hover:-translate-y-1`}
                  >
                    {portal.name}
                  </Link>
                ))}
